            ...
            <el-tab-pane label="表格属性" name="field">
              ...
              >
                <el-form-item label="是否分页">
                  <el-switch value={this.activeData.__config__.isShowPagination} onChange={e => { this.activeData.__config__.isShowPagination = e }}/>
                </el-form-item>
            ...
            <el-collapse-item class="select-item" {...{ scopedSlots }}>
              <div class="table-item">
                ...
                <div class="bottom">
                  ...
                  {item.type === '标签' && this.renderDynamicItems(h, {
                    item,
                    map: item.valMap,
                    tagMap: { tagColors },
                    mapKey: 'valMap',
